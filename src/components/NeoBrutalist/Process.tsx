      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row mb-24 justify-between items-end">
          ...
          <p className="max-w-md text-lg mt-8 md:mt-0 font-medium text-zinc-400">
            Our methodology is a blend of rigorous strategy and unbridled
            creativity.
          </p>
        </div>
            ...
            >
              <div className="py-8 md:py-12 flex justify-between items-center pr-4">
                ...
                <div className="relative w-6 h-6">
                  <div
                    className={`absolute inset-0 flex items-center justify-center transition-transform duration-500 ${openIndex === index ? "rotate-180" : "rotate-0"}`}
                  >
                    {openIndex === index ? (
