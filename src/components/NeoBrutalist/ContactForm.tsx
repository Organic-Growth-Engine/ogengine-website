...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center mt-16 font-mono text-[10px] text-zinc-400 tracking-[0.15em] gap-1 select-none pointer-events-none uppercase">
