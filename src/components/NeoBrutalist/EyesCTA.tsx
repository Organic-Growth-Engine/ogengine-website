...
export default function EyesCTA() {
  return (
    <section className="relative min-h-[70vh] flex flex-col justify-center items-center bg-black py-20 sm:py-28 md:py-36 text-center overflow-hidden">
      <div className="flex flex-col items-center justify-center px-6 w-full">
        {/* Main Heading */}
        <h2 className="text-5xl xs:text-6xl sm:text-7xl lg:text-[120px] pointer-events-none font-heading font-white leading-[0.9] text-white uppercase tracking-tight">
          READY TO
          <br />
          BUILD THE
          <br />
        ...
        <a
          ...
          className="group mt-12 relative cursor-pointer px-12 sm:px-16 py-3 sm:py-4 rounded-full font-heading font-bold text-sm sm:text-base flex gap-2 text-white justify-center items-center overflow-hidden bg-black uppercase tracking-wider"
        >
          {/* Wipe animation */}
          <span
            className="
          ...
          <span className="relative z-10 flex items-center gap-2 transition-colors duration-300">
            <span className="w-1.5 h-1.5 rounded-full bg-white group-hover:opacity-0 transition-opacity duration-300" />
            <span>Explore OGengine</span>
            <span className="w-1.5 h-1.5 rounded-full bg-white opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </span>
        </a>
      </div>
    </section>
